  ...
  return (
    <div className="antialiased min-h-screen flex flex-col font-body-md bg-[#030303] text-white overflow-hidden relative">
      ...
      <nav className="w-full z-50 p-6 absolute top-0 left-0">
        <a href="/" className="inline-flex items-center gap-2 text-on-surface-variant hover:text-white transition-colors duration-200">
          <ArrowLeft size={16} />
      ...
      <main className="flex-grow flex items-center justify-center p-4">
        ...
        <div className="glass-card w-full max-w-md p-8 md:p-10 flex flex-col items-center shadow-2xl relative overflow-hidden">
          ...
          <h1 className="font-headline-md text-[28px] font-bold text-on-surface mb-2 tracking-tight">Welcome Back</h1>
          <p className="text-on-surface-variant text-[14px] mb-8 text-center">Enter your credentials to access your secure vault.</p>

          <form className="w-full space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-1.5">
              <label className="text-[12px] font-medium text-on-surface-variant uppercase tracking-wider pl-1">Email Address</label>
              <input 
                type="email" 
                placeholder="name@company.com" 
                className="w-full bg-[#ffffff05] border border-[#ffffff1a] focus:border-primary/50 focus:ring-1 focus:ring-primary/50 rounded-xl px-4 py-3 text-[14px] text-white placeholder-on-surface-variant outline-none transition-all duration-200"
                required
              />
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center pl-1">
                <label className="text-[12px] font-medium text-on-surface-variant uppercase tracking-wider">Password</label>
